var Hammerhead = HammerheadClient.get('Hammerhead'),
    ...
    KeyPressSimulator = TestCafeClient.get('Automation.Press.KeyPressSimulator'),
...
$(document).ready(function () {
    ...
    var createExpectedLog = function () {
        ...
        if ($.browser.opera || Util.isMozilla) {
    ...
    var logElement = function () {
        var element = Util.getActiveElement();
    ...
    asyncTest('press tab test', function () {
        ...
        var pressTabRecursive = function (callback) {
            KeyPressSimulator.press('tab', function (callback) {
    ...
    asyncTest('press shift+tab test', function () {
        ...
        var pressTabRecursive = function (callback) {
            KeyPressSimulator.press('shift+tab', function (callback) {
                if (focusedElements.length === $expectedFocusedElements.length - 1) {
                    logElement();
