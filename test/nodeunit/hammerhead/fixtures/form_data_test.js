...
var boundary = 'separator',
    readFile = function(fileName) {
        var text = fs.readFileSync(path.join(__dirname, '../data/proxy/data_form_processing/' + fileName + '.formdata'), 'utf8');
        var textFixedForLinux = text.replace(/\n/g, '\r\n').replace(/\r\r\n/g, '\r\n');
        return new Buffer(textFixedForLinux);
    },
    formDataFiles = {
